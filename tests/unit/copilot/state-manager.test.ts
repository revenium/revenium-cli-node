...
const testDir = join(tmpdir(), `revenium-copilot-test-${randomBytes(4).toString("hex")}`);
...
import { loadState, saveState, resetState } from "../../../src/copilot/core/sync/state-manager.js";
